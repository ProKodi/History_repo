...
class DataBase: IDisposable{
    ...
    public async Task<List<RestarantsWithSchedule>> GetRestarantsWithSchedule(){
    ...
    public async Task<List<DishInRestarant>> GetDishesFromRestorant(ulong id_restaurant){
        Task<MySqlDataReader> command = Task.Run(() =>{
    ...
    public async Task<List<ClientsOrders>> GetClientsOrders(string client_email){
        Task<MySqlDataReader> command = Task.Run(() =>{
    ...
    public async Task<List<(string, long)>> GetPopularDishes(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
    ...
    public async Task<List<(string?, DateOnly)>> GetDontReadyOrders(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
    ...
    public async Task<List<(string, double)>> GetAVGReceipt(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
    ...
    public async Task<List<(string, long)>> GetCounterOrder(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
    ...
    public async Task<List<WorkersInRestaurant>> GetWorkersWithUpperSalary(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
                SELECT
    ...
    public async Task<List<(string, long)>> GetOrdersWithManyPosition(long count_orders = 3){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
    ...
    public async Task<List<(string?, double)>> GetOrdersSum(){
        Task<MySqlDataReader> command = Task.Run(() =>{
            using var command = new MySqlCommand("""
