...
class TestFunction(unittest.TestCase):
    ...
    """
    TODO Сделать ввод для данных 
    TODO Данные ввовдятся вот в таком виде: 
    Изначальная комбинация: 0101
    Неправильная комбинация: 1101
    Выводить:
    Правильная комбинация с проверочными битами
    Проверка неправильной комбинации и ее исправление (?)
